INTERFACE zif_etr_edf_xml_k
  ...
  TYPES numberofentries    TYPE ty_common_v1.
  ...
  TYPES entryheader       TYPE STANDARD TABLE OF ty_entryheader WITH NON-UNIQUE KEY totaldebit totalcredit.
