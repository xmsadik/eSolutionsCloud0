  METHOD get_einvoice_rules.
    ...
    SORT: lt_awtyp, lt_vkorg, lt_vtweg, lt_spart, lt_werks, lt_invty, lt_sddty, lt_mmdty, lt_fidty, lt_partner, lt_prfid, lt_vbeln, lt_ktgrd, lt_pstyv.
    DELETE ADJACENT DUPLICATES FROM: lt_awtyp, lt_vkorg, lt_vtweg, lt_spart, lt_werks, lt_invty, lt_sddty, lt_mmdty, lt_fidty, lt_partner, lt_prfid, lt_vbeln, lt_ktgrd, lt_pstyv.
