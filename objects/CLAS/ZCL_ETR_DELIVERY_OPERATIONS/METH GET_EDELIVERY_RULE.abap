  METHOD get_edelivery_rule.
    ...
    SORT: lt_awtyp, lt_vkorg, lt_vtweg, lt_spart, lt_werks, lt_lgort, lt_umwrk, lt_umlgo, lt_sobkz, lt_bwart, lt_dlvty, lt_sddty, lt_mmdty, lt_fidty, lt_partner, lt_prfid.
    DELETE ADJACENT DUPLICATES FROM: lt_awtyp, lt_vkorg, lt_vtweg, lt_spart, lt_werks, lt_lgort, lt_umwrk, lt_umlgo, lt_sobkz, lt_bwart, lt_dlvty, lt_sddty, lt_mmdty, lt_fidty, lt_partner, lt_prfid.
